...
import { kycProviderCopy } from '../../data/account'
...
export function KycContent({ onStart }: { onStart: () => void }) {
    ...
    <>
      ...
      {user.kycStatus === 'unverified' && (
        <>
          ...
          <AuthButton onClick={onStart}>开始 Sumsub 认证</AuthButton>
      ...
      {user.kycStatus === 'verified' && <KycStatusBanner status="verified" />}
